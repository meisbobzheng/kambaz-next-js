    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Cut chicken breast into bite-sized pieces.</li>
          <li>Season chicken with salt and pepper.</li>
          <li>
            Set up breading station with flour, beaten eggs, and seasoned
            breadcrumbs.
          </li>
          <li>Dredge chicken pieces in flour, then egg, then breadcrumbs.</li>
          <li>Heat oil to 350°F in a deep fryer or heavy pot.</li>
          <li>
            Fry chicken pieces in small batches for 3-4 minutes until golden
            brown.
          </li>
      ...
      <br />
      Please{" "}
      <a href="https://github.com/meisbobzheng/wd-kambaz" id="wd-github">
        click here
      </a>{" "}
      to access the github repo.
      <br />
    </div>
  );
}
